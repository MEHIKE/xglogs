...
[exclude]
vaartus = message_center,AutoProbe,Introscope,banklink,errorlog,usertrack,compressed,tva,OracleDBAgent,dgerror,gz,map-rcs,Tomcat,access-logstats,.out,.pid,epa.log,gc,jetty,services_bus
;,jdbc
...
;max_filesize_arh = 20000000
max_filesize_arh =  1000000
;max_filesize_warning =    536870912
max_filesize_warning_arh =  10000000
max_filesize_warning =      50000000
max_filesize_message = "Faili '%1$s' suurus [%3$s] on suurem lubatavast [%2$s], kontrolli asja!"
error_server_message = "Server '%1$s' pole kättesaadav ja logisid ei saa kopeerida. Uuri põhjust!!!"
max_filesize_warningmessage = "Faili '%1$s' suurus [%3$s] on suurem kui keskmine: [%2$s], võib kontrollida asja!"
process_message = "Arhiveerimise protsessi topeltkäivitus. Protsess juba käib, kontrolli asja!"
