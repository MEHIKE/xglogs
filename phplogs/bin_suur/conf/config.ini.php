...
[exclude]
vaartus = message_center,AutoProbe,Introscope,banklink,errorlog,usertrack,compressed,tva,OracleDBAgent,dlg,dgerror,gz,map-rcs,Tomcat,access-logstats,.out,.pid,epa.log,gc,jetty,servicegate,web_krk,mapp,wli,kreedo,dealgate,css,liferayxgate,texts,wap,paym,servicegate
