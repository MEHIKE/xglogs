...
include ('/home/webapp/phplogs/bin_veel/config.class.php');
...
#                                                echo "hetke fail=$fn ja rea nr=$jrk ja selel faili max ridade arv=".$failid[$fn][max]."outarray size=".count($outarray)." \n";
			...
			$result = exec("gzip -f ".$config->config_values[paths][archive_path].make_dir($paev).$rakendus.".log.".$paev, $out);$rakendus.".log.".$paev, $out);
