...
#)
	...
	if (messaging($filename, $config)) {
	 echo "Kopeeritakse käsuga= scp $host_values[user]\@$host:$host_values[mess_path]/$file ".$config->config_values[paths][incoming_path]."$filename \n";
